...
class ConfigurationGenerator:
    ...
    def dump(self):
        ...
        with open(""+HISIMPATH["cfg"]+"/cfg.json", "w") as f:
...
class SetupFunction:
    ...
    def __init__(self):
        if os.path.isfile(""+HISIMPATH["cfg"]+"/cfg.json"):
            with open(os.path.join(""+HISIMPATH["cfg"]+"/cfg.json")) as file:
                self.cfg = json.load(file)
            os.remove(""+HISIMPATH["cfg"]+"/cfg.json")
